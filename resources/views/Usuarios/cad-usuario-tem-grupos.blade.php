...
<x-app-layout>
    <x-slot name="javascript">
        <script src="{{ asset('/js/usuarios/cad-usuarios.js') }}"></script>
    </x-slot>
    <x-slot name="header">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('email_usuario') }}</span>
                                    </div>
                                </div>
                                ...
                                @if ($usuario_id == "")
                                    <div class="form-group">
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('senha_usuario') }}</span>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="error invalid-feedback">{{ $errors->first('confirm_senha_usuario') }}</span>
                                    </div>
                                @endif
                ...
                @if ($usuario_id != "")
                <div class="col-md-9">
                    @include('app-usuarios.users-has-roles.partials.frm-cad-user-has-role')
                </div>
                @endif
